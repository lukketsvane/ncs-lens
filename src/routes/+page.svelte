<script lang="ts">
  import { activeTab, history, communityItems, savedColors, savedColorKeys, dataLoading, loading, detailItem, detailColor, salientMode, showVilkaar } from '$lib/stores/app';
  ...
  import VilkaarPage from '$lib/components/VilkaarPage.svelte';
