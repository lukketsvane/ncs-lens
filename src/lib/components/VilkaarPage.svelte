...
<div class="fixed inset-0 z-50 bg-white overflow-y-auto">
  <div class="min-h-full bg-white safe-area-top safe-area-bottom">
    <!-- Header -->
    <div class="sticky top-0 bg-white border-b border-gray-100 z-10">
      <div class="flex items-center gap-3 p-4">
        <button 
          onclick={() => showVilkaar.set(false)}
          class="p-2 hover:bg-gray-100 rounded-full transition-colors"
        >
          <ChevronLeft size={20} />
        </button>
        <h1 class="font-semibold text-gray-900">Vilkår</h1>
      </div>
    </div>

    <!-- Content -->
    <div class="p-6 max-w-2xl mx-auto pb-24">
      <article class="prose prose-sm prose-gray">
        <h1 class="text-2xl font-bold text-gray-900 mb-2">Vilkår for NCS Fargeverktøy</h1>
        <p class="text-sm text-gray-500 mb-8"><em>Sist oppdatert: 13. januar 2026</em></p>

        <h2 class="text-lg font-bold text-gray-900 mt-8 mb-4">Partar</h2>
        ...
        <h2 class="text-lg font-bold text-gray-900 mt-8 mb-4">Om tenesta</h2>
        ...
        <h2 class="text-lg font-bold text-gray-900 mt-8 mb-4">Prisar og betaling</h2>
        <p class="text-gray-700 mb-4">
        ...
        <h2 class="text-lg font-bold text-gray-900 mt-8 mb-4">Abonnement og oppseiing</h2>
        <p class="text-gray-700 mb-4">
        ...
        <h2 class="text-lg font-bold text-gray-900 mt-8 mb-4">Angrerett</h2>
        <p class="text-gray-700 mb-4">
        ...
        <h2 class="text-lg font-bold text-gray-900 mt-8 mb-4">Retur og refusjon</h2>
        <p class="text-gray-700 mb-4">
        ...
        <h2 class="text-lg font-bold text-gray-900 mt-8 mb-4">Reklamasjon</h2>
        <p class="text-gray-700 mb-4">
        ...
        <p class="text-gray-700 mb-4">Ved gyldig reklamasjon vil vi:</p>
        <ol class="list-decimal list-inside text-gray-700 mb-4 space-y-1">
        ...
        <h2 class="text-lg font-bold text-gray-900 mt-8 mb-4">Klagehandsaming og konfliktløysing</h2>
        <p class="text-gray-700 mb-4">
          Ved usemje, ta først kontakt med oss på iverfinne@gmail.com. Vi svarar innan 5 virkedagar.
        </p>
        <p class="text-gray-700 mb-4">Dersom vi ikkje kjem til semje, kan du klage til:</p>
        <p class="text-gray-700 mb-4">
        ...
        <h2 class="text-lg font-bold text-gray-900 mt-8 mb-4">Personvern</h2>
        <p class="text-gray-700 mb-4">
          Sjå vår personvernerklæring for informasjon om korleis vi handsamar personopplysningar.
        </p>

        <h2 class="text-lg font-bold text-gray-900 mt-8 mb-4">Endringar i vilkåra</h2>
        <p class="text-gray-700 mb-4">
